...
from sse_cracknet_dilatedconv import UNet16, input_size
...
if __name__ == '__main__':
    ...
    parser.add_argument('-img_dir',type=str, default='F:\\u-net\\crack_segmentation_dataset\\test1\\images', help='input dataset directory')
    parser.add_argument('-model_path', type=str, default='F:\\u-net\\thindata_sccdd32\\model_best.pt',help='traz`ined model path')
    parser.add_argument('-model_type', type=str,default='vgg16', choices=['vgg16', 'resnet101', 'resnet34'])
    parser.add_argument('-out_viz_dir', type=str, default='F:\\u-net\\crack_segmentation_dataset\\test1\\visualization_output',  help='visualization output dir')
    parser.add_argument('-out_pred_dir', type=str, default='F:\\u-net\\crack_segmentation_dataset\\test1\\prediction_output', required=False,  help='prediction output dir')
