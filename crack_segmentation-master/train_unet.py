...
from sse_cracknet_dilatedconv import UNet16, UNetResNet
...
if __name__ == '__main__':
    ...
    parser.add_argument('-n_epoch', default=40, type=int, metavar='N', help='number of total epochs to run')
    ...
    parser.add_argument('-data_dir', type=str, default='F:\\u-net\\crack_segmentation_dataset\\train1',
                        help='input dataset directory')
    parser.add_argument('-model_dir', type=str, default='F:\\u-net\\thindata_sccdd32',
